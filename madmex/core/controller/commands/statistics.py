...
INITIAL_ARRAY = {'Bosque de Coníferas de Oyamel Ayarín Cedro' : [1],
                 'Bosque de Coníferas de Pino y Tascate' : [3],
                 'Bosque de Encino y Bosque de Galería' : [2],
                 'Chaparral' : [6],
                 ...
                 'Matorral Rosetófilo Costero' : [23],
                 'Matorral Desértico Rosetófilo' : [21],
                 'Popal' : [15],
                 'Tular' : [14],
                 'Vegetación de Dunas Costeras' : [20],
                 'Vegetación de Desiertos Arenosos' : [24],
                 'Vegetación Halófila Hidrófila' : [25],
                 'Vegetación Halófila Xerófila y Gipsófila' : [26],
                 'Pastizales' : [27],
                 'Tierras Agrícolas' : [28],
