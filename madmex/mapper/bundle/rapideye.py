...
from madmex.preprocessing import maskingcloudsandshadowswithreference
...
class Bundle(BaseBundle):
    ...
    def masking_with_time_series(self):
        image_clouds_shadows_masked_path = maskingcloudsandshadowswithreference.masking(self)
