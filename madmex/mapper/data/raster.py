...
class Data(BaseData):
    ...
    def _extract_metadata(self):
        ...
        self.metadata['data_shape'] = (self.data_file.RasterXSize, self.data_file.RasterYSize, self.data_file.RasterCount)
    ...
    def _get_footprint(self):
        ...
        ring.AddPoint_2D(geotransform[0] + geotransform[1] * data_shape[0], geotransform[3] + geotransform[5] * data_shape[1])  
