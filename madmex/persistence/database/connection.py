...
class RapideyeFeatures(BASE):
    ...
    band_1_min = Column(Float)
    band_2_min = Column(Float)
    band_3_min = Column(Float)
    band_4_min = Column(Float)
    band_5_min = Column(Float)
    band_1_max = Column(Float)
    band_2_max = Column(Float)
    band_3_max = Column(Float)
    band_4_max = Column(Float)
    band_5_max = Column(Float)    
    top = Column(Float)
    left = Column(Float)
    time = Column(Float)
