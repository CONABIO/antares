...
def create_filename(path, file_name):
    '''
...
def get_files_from_folder_filter(path, regex):
    '''
    Returns a list with the files found in the given path filtered by the given regex.
    '''
    pattern = re.compile(regex) 
    return [f for f in os.listdir(path) if os.path.isfile(os.path.join(path, f)) and pattern.match(f)]
...
SCENES_MEXICO = ["18,45","18,46","18,47","19,45","19,46","19,47","19,48","20,45","20,46","20,47","20,48","20,49","21,45","21,46","21,47","21,48","21,49","21,50","22,45","22,47","22,48","22,49","23,47","23,48","23,49","24,46","24,47","24,48","24,49","25,45","25,46","25,47","25,48","25,49","26,42","26,43","26,44","26,45","26,46","26,47","26,48","26,49","27,41","27,42","27,43","27,44","27,45","27,46","27,47","27,48","28,40","28,41","28,42","28,43","28,44","28,45","28,46","28,47","28,48","29,39","29,40","29,41","29,42","29,43","29,44","29,45","29,46","29,47","30,39","30,40","30,41","30,42","30,43","30,44","30,45","30,46","30,47","31,39","31,40","31,41","31,42","31,43","31,44","31,45","31,46","32,38","32,39","32,40","32,41","32,42","32,43","32,44","33,38","33,39","33,40","33,41","33,42","33,43","33,44","34,38","34,39","34,40","34,41","34,42","34,43","34,44","34,47","35,38","35,39","35,40","35,41","35,42","35,43","36,38","36,39","36,40","36,41","36,42","36,43","36,47","37,38","37,39","37,40","37,41","38,37","38,38","38,39","38,40","38,41","39,37","39,38","39,39","40,37","40,38","40,40"]
TM = {'browse_url':1,
      'scene_id':2,
...
if __name__ == '__main__':
    print get_basename('/LUSTRE/MADMEX/eodata/rapideye/1447720/2013/2013-02-11/l3a/myawesomefile.ext.json')
    ...
    print create_filename('/LUSTRE/MADMEX/staging/antares_test/oli_tirs/21048/2015/2015-01-15/sr', get_basename_of_file('/LUSTRE/MADMEX/eodata/oli_tirs/21048/2015/2015-01-15/sr/LC80210482015015LGN00_MTL.txt'))
